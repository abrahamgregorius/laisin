                ...
                <div class="product-card">
                    <div class="product-img">
                        @if($product->thumbnail != "")
                          <img class="img-product" src="{{ url($product->thumbnail)}}" alt="picture">
                        @else
                          <img class="img-product" src="{{ asset('assets/no-image.webp') }}" alt="img">
                        @endif
                    </div>
    ...
    <div class="container mx-auto">
        ...
        <div class="about-us-wrappers row">
            <div class="wrappers-left col-md-6">
                <div class="img">
                    <img src="https://i.ibb.co/4P1S6vH/49b7f0b9-1e77-4f28-b5f9-bca2bd446903.png" alt="">
                </div>
            </div>
                    ...
                    <div class="testi-wrappers">
                        ...
                        <div class="testi-description">
                            ...
                            <p>
                                ...
                                Exceptional customer service and swift part delivery by Laisindo Anugerah always make them my top automotive pick.                            </p>
                        </div>
                    </div>  
                  </div>
              </div>
