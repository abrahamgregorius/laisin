...
<div class="laisin-hero">
    ...
    <div class="hero-text">
        ...
        <div class="hero-buttons">
            <a href="/products" class="find-part">Find A Part</a>
            <a href="/contacts" class="contact">Contact</a>
        </div>
    </div>
</div>
  ...
  <div class="container mx-auto">
        ...
        <div class="product-lists row">
                ...
                <div class="product-card">
                    ...
                    <div class="product-description">
                        <div class="descriptions">
                            With decades of precision engineering experience, our cutting-edge factory produces a wide range of high-quality automotive spare parts, meeting the strict standards of safety and performance.
                        </div>
            ...
            <div class="col-md-4">
                <div class="product-card">
                    <div class="product-img">
                        <img class="img-product" src="https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80" alt="picture">
                    </div>
                    <div class="product-description">
                        <div class="descriptions">
                            Leveraging advanced technology and a skilled team, we offer custom solutions for engine components, transmission systems, and more, enhancing vehicle functionality and longevity.
                        </div>
                        {{-- <div class="description-details">
                            <div class="detail detail-part">
                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
            ...
            <div class="col-md-4">
                <div class="product-card">
                    <div class="product-img">
                        <img class="img-product" src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="picture">
                    </div>
                    <div class="product-description">
                        <div class="descriptions">
                            Committed to sustainability, our eco-friendly practices reduce the ecological footprint of our spare parts, making us a trusted partner in the automotive industry's future.
                        </div>
                        {{-- <div class="description-details">
                            <div class="detail detail-part">
                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
        ...
        <div class="about-us-wrappers row">
            ...
            <div class="wrappers-right col-md-6">
               <div class="text-content">
                   <h4>We provide top-notch customer service while delivering unbeatable value for high-quality vehicles.</h4>
                   <p>Laisindo Anugerah Jaya Abadi, a name synonymous with excellence in the automotive spare parts industry, is a distinguished and forward-thinking manufacturing powerhouse. With a rich history rooted in precision engineering spanning several decades, our factory has earned its reputation as a premier provider of high-quality spare parts for automobiles. As an industry leader, we continually strive to exceed the exacting standards of safety, reliability, and performance demanded by today's automotive landscape.</p>
                </div>
                <div class="content-promotion">
                      ...
                      <div class="promotion-text">
                        <h5>
                          ...
                          <p>
                            Quality vehicles, unbeatable prices, outstanding buying experience.</p>
                      </div>
                </div>
                <div class="content-promotion">
                      <div class="promotion-icon">
                      ...
                      <div class="promotion-text">
                        <h5>
                          ...
                          <p>Trusted, genuine parts, unbeatable value.</p>
                      </div>
                ...
                <div class="content-promotion">
                      ...
                      <div class="promotion-text">
                        <h5>
                          ...
                          <p>
                            A decade strong, we offer trusted genuine parts and exceptional value.
                        </p>
                      </div>
                </div>
            </div>
              ...
              <div class="col-md-6">
                  <div class="testi-card">
                    ...
                    <div class="testi-wrappers" style="z-index: 2">
                        <div class="testi-img">
                            <img src="https://images.unsplash.com/photo-1520341280432-4749d4d7bcf9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80" alt="person">
                        </div>
              ...
              <div class="col-md-6">
                <div class="testi-card">
                    ...
                    <div class="testi-wrappers">
                        <div class="testi-img">
                            <img src="https://i.pinimg.com/564x/ed/64/86/ed6486a863433daddbb2df770d4c0cde.jpg" alt="person">
                        </div>
                        <div class="testi-description">
                            <h5>Faris Sanjaya</h5>
                ...
                <div class="right-wrappers-more-info">
                    <div class="text-buttons">
                        ...
                        <div class="need-more-buttons">
                            <a href="/contacts" class="contact-us-button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                              </svg>Contact Us</a>
                            <a  href="/products" class="find-parts-button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
