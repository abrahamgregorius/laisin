...
{{-- No shadow hero --}}
<div class="px-4 py-5 my-5 text-center bg-warning rounded">
    ...
    <div class="col-lg-6 mx-auto">
        ...
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <a href="{{ route('products.index') }}"><button type="button" class="btn btn-dark text-warning btn-lg px-4 me-md-2 fw-bold">Find A Part</button></a>
