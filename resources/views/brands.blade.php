...
<div class="container mx-auto mt-4">
    ...
    <div class="laisin-search">
        ...
        <input id="search-homepage-brand" type="text" placeholder="Search Brand Name" class="form-control">
    </div>
    <div class="laisin-table">
        ...
        <table class="table">
            ...
            <tbody id="search-homepage-brand-data">
                @foreach($brands as $brand)
                    <tr class="table-item">
                        <td><a href="{{ route('brands.show',$brand->slug)}}">{{ $brand->brand_name }}</a></td>
                        <td>{{ count($brands) }}</td>
                    </tr>
                @endforeach
            </tbody>
