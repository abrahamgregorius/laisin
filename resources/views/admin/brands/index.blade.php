...
<div class="brands-header d-flex align-items-center justify-content-between my-3">
    <h3>Brands</h3>
    <a href="{{ route('create.brand.index') }}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
    ...
    <div class="col-12">
        <div class="col-lg-4 col-12 mb-4">
            <div class="search d-flex gap-2">
                <input type="text" placeholder="Cari Brand" class="form-control">
        ...
        <div class="card">
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><a href="{{ route('show.brand', 2) }}">Toyota Hens</a></td>
                        <td>2</td>
                        <td class="d-flex">
                            {{-- ganti 2 nya jadi $brands->id --}}
                            <a href="{{ route('edit.brand', 2) }}" class="btn btn-warning">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                    ...
                                    {{-- ganti 2 nya jadi $brands->id --}}
                            <form action="{{ route('delete.brand',2) }}" method="post">
                                @csrf
                                @method('DELETE')
