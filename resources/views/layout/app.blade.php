    ...
    <header>
        <nav class="laisin-navbar container">
            ...
            <ul class="laisin-menu">
                ...
                <li class="@if(request()->routeIs('products.show')) laisin-active @endif"><a href="{{ route('products.show') }}">Products</a></li>
                <li class="@if(request()->routeIs('contacts.index')) laisin-active @endif"><a href={{ route('contacts.index') }}>Contact</a></li>
                <li class="@if(request()->routeIs('products.show')) {{-- laisin-active --}} @endif">
