...
<section class="laisin-years-page">
    <div class="container mx-auto mt-4">
        ...
        <div class="laisin-search">
            ...
            <input id="search_homepage_year" type="text" placeholder="Search Year Name" class="form-control">
        </div>
        <div class="laisin-table">
            ...
            <table class="table">
                ...
                <tbody id="search_homepage_year_data">
                    @foreach($years as $year)
                        <tr class="table-item">
                            <td><a href="{{ route('year.detail',$year) }}">{{ $year }}</a></td>
                            <td>{{ $productCounts[$year] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
